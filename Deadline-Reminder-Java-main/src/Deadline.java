...
public abstract class Deadline {
    ...
    public Deadline(String title, String type, Date dueDate, String subject, String teamMembers) {
        this.title = title; this.type = type; this.dueDate = dueDate; this.subject = subject; this.teamMembers = teamMembers;
    }
    ...
    @Override
    public String toString() { return id + ": " + title + " (" + type + ") due " + dueDate; }
}
